...
<script type="text/javascript" src="${path}/ecps/console/res/js/item/editbrand.js"></script>
</head>
<body id="main">
...
<div class="frameR"><div class="content">
    ...
    <div class="loc icon"><samp class="t12"></samp>当前位置：商品管理&nbsp;&raquo;&nbsp;<a href="${path}/brand/listBrand.do" title="品牌管理">品牌管理</a>&nbsp;&raquo;&nbsp;<span class="gray">编辑品牌</span>
	...
	<input type="hidden" name="lastRealPath" id="lastRealPath">
		<div class="edit set">
            ...
            <p><label class="alg_t"><samp>*</samp>品牌LOGO：</label><img id='imgsImgSrc' src="${request_file_path}${brand.imgs}" height="100" width="100" />
            </p>
