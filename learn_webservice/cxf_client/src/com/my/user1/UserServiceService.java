 ...
 * 
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://service.my.com/", wsdlLocation = "http://localhost:6666/user?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://service.my.com/", "UserServiceService");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://service.my.com/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.my.com/", "UserServicePort"), UserService.class, features);
    }
