...
<script type="text/javascript" src="${path }/ecps/console/res/js/item/addItem.js">
</script>
</head>
<body id="main">
...
<div id="tab_3" class="edit set" style="display: none">
   <c:if test="${fn:length(commFeatureList) == 0 }">
   		<p><label>无属性</label></p>
   </c:if>
   <c:forEach items="${commFeatureList}" var="feature">
   	<p>
...
<div id="tab_4" style="display:none">
    <div id="sp_0" class="sp_0">
        <table cellspacing="0" summary="" class="tab3">
            <c:if test="${fn:length(specFeatureList) == 0}">
            <tr><th colspan="2" class="gray b">&nbsp;&nbsp;<b>默认</b></th></tr>
            </c:if>
            <c:forEach items="${specFeatureList}" var="feature">
            	<tr>
