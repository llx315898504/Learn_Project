...
<script type="text/javascript" src="${path}/ecps/console/res/js/item/addbrand.js"></script>
</head>
<body id="main">
...
<div class="frameR"><div class="content">
	...
	<div class="loc icon"><samp class="t12"></samp>当前位置：商品管理&nbsp;&raquo;&nbsp;<a href="${path}/brand/listBrand.do" title="品牌管理">品牌管理</a>&nbsp;&raquo;&nbsp;<span class="gray">添加品牌</span>
