 ...
 * 
 */
@WebServiceClient(name = "PersonServiceService", targetNamespace = "http://service.user.my.com/", wsdlLocation = "http://192.168.1.101:9980/Person?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICESERVICE_QNAME = new QName("http://service.user.my.com/", "PersonServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.101:9980/Person?wsdl");
    ...
    public PersonService getPersonServicePort() {
        return super.getPort(new QName("http://service.user.my.com/", "PersonServicePort"), PersonService.class);
    }
    ...
    public PersonService getPersonServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.user.my.com/", "PersonServicePort"), PersonService.class, features);
    }
