 ...
 * 2018-09-02T10:03:08.031+08:00
 * Generated source version: 2.4.2
 * 
 */
@WebServiceClient(name = "UserServiceService", 
                  wsdlLocation = "http://localhost:8080/cxf_web_server/services/userService?wsdl",
                  targetNamespace = "http://service.my.com/") 
public class UserServiceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://service.my.com/", "UserServiceService");
    public final static QName UserServicePort = new QName("http://service.my.com/", "UserServicePort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/cxf_web_server/services/userService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/cxf_web_server/services/userService?wsdl");
        }
        WSDL_LOCATION = url;
    }
